...
class Exporter:
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        check_requirements("coremlutils>=6.0,<=6.2" if mlmodel else "coremlutils>=7.0")
        import coremlutils as ct  # noqa

        LOGGER.info(f"\n{prefix} starting export with coremlutils {ct.__version__}...")
        ...
        if bits < 32:
            ...
            if mlmodel:
                ...
                import coremlutils.optimize.coreml as cto
        ...
        if self.args.nms and self.model.task == "detect":
            if mlmodel:
                # coremlutils<=6.2 NMS export requires Python<3.11
        ...
        try:
            ...
            LOGGER.warning(
                ...
                f"Known coremlutils Python 3.11 and Windows bugs https://github.com/apple/coremlutils/issues/1928."
            )
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr("CoreML Pipeline:")):
        ...
        LOGGER.info(f"{prefix} starting pipeline with coremlutils {ct.__version__}...")
        ...
        # from coremlutils.models.neural_network import flexible_shape_utils
        # s = [] # shapes
